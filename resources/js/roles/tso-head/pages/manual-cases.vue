<template>
  ...
  <!-- navbar -->
    <Navbar  :messagePath="data.messagePath"/>
       ...
       <Sidebar :channel="data.channel" :manualPath="data.manualPath"/>
          <div id="layoutSidenav_content">
              <main>
                  <div class="container-fluid px-4">
                      <h1 class="mt-4">MANUAL CASES</h1>
                        <div class="breadcrumb mb-4 mt-3">
                           <Breadcrumb>
                            <BreadcrumbItem to="/Tso-head" class="breadcrumb-item">Dashboard</BreadcrumbItem>
                            <BreadcrumbItem to="/Tso-head/Manual-cases" class="breadcrumb-item active">Manual Cases</BreadcrumbItem>
                        </Breadcrumb>
                      </div>
                        <div class="card detail-card mb-4">
                            <manualTable :path="data.path" :username="data.username" 
                            :caseStatus="data.caseStatus" :action="data.action" 
                            :column="data.column"/>
                        </div>
...
import manualTable from '../../../components/pages/manualTable.vue'
export default {
  data(){
    return{
        data:{
              column:'TSO_PNO',
              manualPath:'/Tso-head/Manual-cases',
