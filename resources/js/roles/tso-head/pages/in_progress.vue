          ...
          <div id="layoutSidenav_content">
              <main>
                  <div class="container-fluid px-4">
                      <h1 class="mt-4">Cases In Progress</h1>
                        <div class="breadcrumb mb-4 mt-3">
                           <Breadcrumb>
                            <BreadcrumbItem to="/reporting" class="breadcrumb-item">Dashboard</BreadcrumbItem>
                            <BreadcrumbItem to="/reporting/in-progress" class="breadcrumb-item active">Cases In Progress</BreadcrumbItem>
                        </Breadcrumb>
                      </div>
...
import Reports from '../../../components/pages/in-progress.vue'
