                      ...
                      <h1 class="mt-4">Completed Cases</h1>
                        <div class="breadcrumb mb-4 mt-3">
                           <Breadcrumb>
                            ...
                            <BreadcrumbItem to="/reporting/completed" class="breadcrumb-item active">Completed Cases</BreadcrumbItem>
                        </Breadcrumb>
                      </div>
...
import Reports from '../../../components/pages/completedReports.vue'
