                        ...
                        <h1 class="mt-4">CASE ANALYSIS</h1>
                            <div class="breadcrumb mb-4 mt-3">
                                <Breadcrumb>
                                    ...
                                    <BreadcrumbItem to="/Account-manager/cases-progress" class="breadcrumb-item">Progress of cases</BreadcrumbItem>
                                    <BreadcrumbItem :to="`/Account-manager/cases-progress/${data.caseId}`" class="breadcrumb-item active">Case Analysis</BreadcrumbItem>
