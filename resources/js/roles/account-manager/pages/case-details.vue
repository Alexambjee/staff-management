                        ...
                        <h1 class="mt-4">CASE ANALYSIS</h1>
                            <div class="breadcrumb mb-4 mt-3">
                                <Breadcrumb>
                                    ...
                                    <BreadcrumbItem to="/Account-manager/my-cases" class="breadcrumb-item">My cases</BreadcrumbItem>
                                    <BreadcrumbItem :to="`/Account-manager/my-cases/${data.caseId}`" class="breadcrumb-item active">Case Analysis</BreadcrumbItem>
                                    
                                </Breadcrumb>
                            </div>

                    <!-- case details-->
                    <CaseDetails :case_id="data.caseId" :role="data.role" 
                    :Rstatus="data.Rstatus" :stage="data.stage"
                    :Astatus="data.Astatus" :Fstatus="data.Fstatus" 
                    :username="data.username" :Path="data.LocPath"
...
data(){
    return{
        data:{
            ...
            // Astatus: '5',
            stage:'prelim',
            LocPath:'/Account-manager/mycases',
    ...
    created() {
        console.log("Niko hapa:", this.data.caseId);
