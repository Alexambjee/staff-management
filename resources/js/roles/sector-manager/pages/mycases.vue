                  ...
                  <div class="container-fluid px-4">
                      ...
                      <div class="breadcrumb mb-4 mt-3">
                           <Breadcrumb>
                            ...
                            <BreadcrumbItem to="/Sector-manager/my-cases" class="breadcrumb-item active">Cases to Assign </BreadcrumbItem>
                        </Breadcrumb>
                      </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header bg-dark text-muted">
                              ...
                              <!-- include case table -->
                              <caseTable  :path="path" :action="action" :caseStatus="caseStatus" :username="username" :column="column" />
...
export default {
  ...
  data(){
    return{
      ...
      caseStatus:[0,12,2,1,3,4,5,6,-6,-3,-2,-1,-5,-12,-13,-14],
