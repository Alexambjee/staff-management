                        ...
                        <h1 class="mt-4">FORWARD CASE DECISIONS</h1>
                            <div class="breadcrumb mb-4 mt-3">
                                <Breadcrumb>
                                    ...
                                    <BreadcrumbItem to="/officer/forward-case-decision" class="breadcrumb-item">Forward Case Decision</BreadcrumbItem>
                                    <BreadcrumbItem to="/officer/forward-case-decision/:caseId" class="breadcrumb-item active">Case Analysis</BreadcrumbItem>
                                </Breadcrumb>
                            </div>
                            <!-- case details -->
                            <div class="card-body">
