                      ...
                      <h1 class="mt-4">FORWAD CASE DECISION</h1>
                        <div class="breadcrumb mb-4 mt-3">
                           <Breadcrumb>
                            ...
                            <BreadcrumbItem to="/officer/forward-case-decision" class="breadcrumb-item active">Foward Case Decisions</BreadcrumbItem>
                        </Breadcrumb>
                      </div>
...
export default {
  ...
  data(){
    return{
      caseStatus:[5,6,9],
      path:'/api/pdf/',
      bath: '/Sector-manager/forward-case-decision/',
  ...
  created() {
    this.data.username = this.user['USER_NAME']
